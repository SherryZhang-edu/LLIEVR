...
def main():
    ...
    sequence_path  = "datasets\\RealData\\video_turnoff"
    ...
    results_enhanced = evaluate_sequence(
        ...
        enhance=True,
        enhance_mode='every',
        save_vis=True, vis_save_dir = "experiments\\results\\RealData\\video_turnoff_enhanced"
    )
    ...
    results_adaptive = evaluate_sequence(
        ...
        tau_mu=50,
        tau_I=10,save_vis=True, vis_save_dir = "experiments\\results\\RealData\\video_turnoff_adaptiveenhanced"
    )
    ...
    # ===============================
    print("\n============================")
    print("Proxy Evaluation on video_turnoff")
    print("============================")
